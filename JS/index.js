...
(function run() {
    ...
    let planes = [
        ...
        new MilitaryPlane('F-15', 1500, 12000, 10000, militaryTypes.bomber),
        new MilitaryPlane('F-22', 1550, 13000, 11000, militaryTypes.bomber),
    ...
    console.log(`Military airport sorted by max distance: ${Airport.getPrintPlanesList(militaryAirport.sortByMaxDistance())}`);
    console.log(`Passenger airport sorted by max speed: ${Airport.getPrintPlanesList(passengerAirport.sortByMaxSpeed())}`);
    console.log(`Plane with max passenger capacity: ${Airport.getPrintPlanesList(passengerAirport.getPassengerPlaneWithMaxPassengersCapacity())}`);
})();